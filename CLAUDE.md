...
| Зона             | Пути                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| ---------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **SDUI**         | `src/features/sdui/`, `src/pages/documents/document-redirect/`, `src/pages/sdui-catch-all/`, `src/pages/module/`, `src/pages/admin/` (админка конструктора дизайна), `src/pages/universal-domain/universal-domain-entry/`, `src/features/theme-settings/`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| **Легаси**       | `src/features/form-renderer/`, `src/features/generate-form-config/`, `src/features/tarifikatsiya/`, `src/features/dict-sidebar/`, `src/features/report-result-view/`, `src/features/report-settings/`, `src/pages/documents/documents-entry/ui/legacy-document-entry-page.tsx`, `src/pages/documents/document-list/`, `src/pages/documents/document-movements/`, `src/pages/dictionaries/`, `src/pages/account-plan/`, `src/pages/account-card/`, `src/pages/accounting-register/`, `src/pages/accumulation-register/`, `src/pages/information-register/`, `src/pages/financing-plan-upload/`, `src/pages/osv-report/`, `src/pages/reports/`, `src/pages/reportalt/`, `src/pages/universal-domain/universal-domain-list/`, `src/entities/form-config/`, `src/shared/lib/eav/`, `src/shared/lib/filter/`, `src/shared/lib/dictionary-entry/` |
| **Общее**        | `src/shared/ui/`, `src/shared/api/`, `src/shared/types/`, `src/shared/design/`, `src/entities/*` (кроме form-config и контура аналитики/ИИ), `src/features/workspace-tabs/`, `src/features/table-filter/`, `src/features/navigation-buttons/`, `src/features/favorite-button/`, `src/features/auth/`, `src/features/face-auth/`, `src/features/support-call/`, `src/features/background-tasks/`, `src/features/notification-center/`, `src/features/treasury-export/`, `src/pages/login/`, `src/pages/change-password/`, `src/pages/main/`, `src/pages/audit-log/`, `src/pages/inactivity-locks/`, `src/widgets/*`, `src/app/`                                                                                                                                                                                                              |
| **Аналитика/ИИ** | Самостоятельный контур, не зависит ни от SDUI, ни от легаси: `src/pages/analytics/`, `src/features/analytics-assistant/`, `src/features/analytics-params/`, `src/features/analytics-widgets/`, `src/features/ai-assistant/`, `src/features/ai-connections/`, `src/entities/analytics/`, `src/entities/ai-assistant/`, `src/entities/ai-connection/`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |

**Точка ветвления:** `src/pages/sdui-catch-all/` — SDUI-экран по умолчанию, легаси-фолбэк через диспетчер `lib/kind-to-legacy.tsx` (старая точка `document-entry-page.tsx` удалена, легаси-карточка — `documents-entry/ui/legacy-document-entry-page.tsx`).
...
Исключение (сложившаяся практика, узаконено 2026-09-18): в `shared/` папка-компонент или папка-утилита может иметь свой `index.ts` как публичный API (`shared/ui/buttons/`, `shared/ui/icons/`, `shared/ui/inputs/`, `shared/lib/table-export/` и т.п.) — у `shared/` нет слайсов, эти папки и есть его единицы экспорта. Новые barrel'ы глубже одного уровня (`shared/ui/x/y/index.ts`) не создавать.
