...
// useDesignRefresh тянет useQueryClient — в юнит-тесте провайдера нет,
// а реакция на флаги дизайна здесь не проверяется.
vi.mock('./use-design-refresh', () => ({
  useDesignRefresh: () => () => undefined,
}))
