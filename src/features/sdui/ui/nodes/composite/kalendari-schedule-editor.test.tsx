...
const rows = [
  ...
  },
  {
    rowId: 'day-2',
    NomerDnya: 2,
    VremyaNachala: '2000-01-01T10:00:00',
    VremyaOkonchaniya: '2000-01-01T17:00:00',
  },
]
...
describe('KalendariScheduleEditor', () => {
  it('replaces only the selected day and keeps the full snapshot for other days', () => {
    ...
    fireEvent.click(
      screen.getByRole('button', { name: 'sdui.kalendari.apply' })
    )
      ...
      <KalendariScheduleEditor
        ...
        allRows={[
          ...rows,
          {
            rowId: 'overlap',
            NomerDnya: 1,
            VremyaNachala: '2000-01-01T17:00:00',
            VremyaOkonchaniya: '2000-01-01T19:00:00',
          },
        ]}
        onApply={onApply}
        onClose={vi.fn()}
