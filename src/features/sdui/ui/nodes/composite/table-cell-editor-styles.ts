 ...
 * (`isNoWrapColumn` — ФИО, должность, «Источник финансирования»): одна строка,
 * лишнее срезается многоточием. Обрезка обязательна: без неё nowrap-текст снова
 * вылез бы на соседнюю колонку — ровно то, ради чего перенос и вводился.
 */
