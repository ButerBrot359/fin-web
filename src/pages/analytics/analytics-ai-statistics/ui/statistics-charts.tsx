          ...
          series={[
            {
              ...
              label: copy.requests,
              color: cssVar(palette.pendingAiStatsPrimary),
              showMark: false,
            },
            {
              data: data.series.map((r) => r.errorCount),
              label: copy.errors,
              color: cssVar(palette.pendingAiStatsError),
              showMark: false,
            },
          ]}
        />
        ...
        <BarChart
          ...
          series={[
            ...
            },
            {
              ...
              label: copy.output,
              stack: 'tokens',
              color: cssVar(palette.pendingAiStatsSecondary),
            },
          ]}
        />
      ),
          ...
          series={[
            {
              ...
              color: cssVar(palette.pendingAiStatsCost),
              valueFormatter: (v) =>
