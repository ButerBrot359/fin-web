          ...
          renderTags={(tagValue) => {
            ...
            return (
              <Box
                ...
                sx={{
                  // Значение позиционируем ТЕМ ЖЕ paddingTop:22, что тема даёт
                  // инпуту/секциям дат (filled-вариант): текст садится в нижнюю
                  // половину бокса — «ниже центра», ровно на уровне значения
                  // «Периода». Прижимаем к верху (flex-start), иначе центрирование
                  // темы подняло бы сводку выше текста дат. Значения 22/6 — из темы,
                  // не подобранные на глаз.
